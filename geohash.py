...
#Accesses the current time, and the latest BTC:USD value call on BitAverage to make a long string of text. This text is then hashed and converted to decimal values, with the front 20 digits being appended to the first 3 or 4 of the Latitude and the last 20 being appended to the first 3 or 4 of the Longitutde. This pair is then truncated at 5 decimal places and returned.
